...
class ViewController: UIViewController, LFLiveSessionDelegate {
    ...
    var closeButton: UIButton = {
        ...
        closeButton.setImage(UIImage(named: "close_preview"), for: UIControl.State.normal)
        return closeButton
    }()
    ...
    var cameraButton: UIButton = {
        ...
        cameraButton.setImage(UIImage(named: "camra_preview"), for: UIControl.State.normal)
        return cameraButton
    }()
    ...
    var startLiveButton: UIButton = {
        ...
        startLiveButton.backgroundColor = .yellow
